  ...
  function createStyles() {
    ...
    style.textContent = `
      ...
      .chatbot-input:focus {
        background: white;
        border-color: #af1f31;
        box-shadow: 0 0 0 3px rgba(175, 31, 49, 0.1);
      }
      ...
      .chatbot-send {
        ...
        justify-content: center;
        transition: all 0.2s ease;
        box-shadow: 0 2px 8px rgba(175, 31, 49, 0.2);
      }
            ...
            <div class="chatbot-header-content">
              <div class="chatbot-header-brand">
                ...
                <div class="chatbot-header-text">
                  ...
                  <div class="chatbot-phone-number">CALL US <a href="tel:1-844-844-6638" style="color: white; text-decoration: underline;">1-844-844-6638</a></div>
                </div>
              </div>
